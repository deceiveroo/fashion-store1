                  ...
                  <div className="relative" data-user-menu>
                    ...
                    {isUserMenuOpen && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        data-user-menu
                        className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 z-[70]"
                      >
                        ...
                        <div className="py-2">
                          <Link 
                            href="/profile"
                            className="flex items-center gap-3 px-4 py-3 text-base text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                        ...
                        >
                          <div className="relative">
                            ...
                            {unreadCount > 0 && (
                              <span className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-red-500 to-pink-500 text-white text-[10px] rounded-full font-bold flex items-center justify-center animate-pulse">
                                {unreadCount > 9 ? '9+' : unreadCount}
                              </span>
                            )}
                          </div>
                          <div className="flex-1">
                            <span className="text-base font-medium text-gray-900 dark:text-white">Уведомления</span>
                            {unreadCount > 0 && (
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 py-2">
                          <button
                            ...
                            className="flex items-center gap-3 px-4 py-3 w-full text-left hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-red-600 dark:text-red-400 text-base"
                          >
                            <LogOut size={20} />
                            <span>Выйти</span>
                          </button>
