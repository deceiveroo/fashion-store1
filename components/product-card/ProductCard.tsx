    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Bottom CTA strip */}
          <motion.div
            className="absolute inset-x-0 bottom-0 z-10 flex items-center justify-between gap-2 p-3"
            initial={false}
            animate={{ opacity: hovered ? 1 : 0, y: hovered ? 0 : 8 }}
            transition={{ type: 'spring', stiffness: 380, damping: 28 }}
          >
            <span className="inline-flex items-center gap-1 text-[11px] font-medium uppercase tracking-wider text-white">
              Смотреть
            ...
            {currentStock && (
              <button
                ...
                className="inline-flex items-center gap-1.5 bg-white px-3 py-1.5 text-[11px] font-medium uppercase tracking-wider text-gray-900 transition-colors hover:bg-neutral-100"
              >
