                      ...
                      <div className="mb-4 flex items-start justify-between">
                        ...
                        {coupon.alreadyPurchased && (
                          <motion.div 
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-sm font-bold rounded-full shadow-lg shadow-green-500/30 flex items-center gap-2"
                          >
                      ...
                      <motion.button
                        ...
                        className={`w-full py-3 rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 text-sm ${
                          coupon.alreadyPurchased
                            ...
                            : 'bg-gradient-to-r from-yellow-500 via-orange-500 to-pink-500 hover:from-yellow-600 hover:via-orange-600 hover:to-pink-600 text-white shadow-xl hover:shadow-2xl hover:shadow-orange-500/40'
                        }`}
                      >
